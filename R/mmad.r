...
#' 
#' \code{distr.mmad} calculates the maximum absolute difference within 
...
distr.mmad <- function(x,y, mid=FALSE){
  if(length(x) < 9 || length(y) < 9){ warn('x or y contain less than 10 values')}
